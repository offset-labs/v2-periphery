...
import UniswapV2Factory from '@offsetcarbon/v2-core/build/UniswapV2Factory.json'
import IUniswapV2Pair from '@offsetcarbon/v2-core/build/IUniswapV2Pair.json'
